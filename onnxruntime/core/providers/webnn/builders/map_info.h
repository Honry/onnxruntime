...
const std::map<std::string_view, std::vector<std::string_view>> decomposed_op_map = {
    ...
    {"MultiHeadAttention",
     {"Add", "Cast", "Concat", "MatMul", "Reshape", "Softmax", "Split", "Transpose"}},
    {"RotaryEmbedding",
     {"Add", "Concat", "Expand", "Gather", "Mul", "Reshape", "Split", "Transpose"}},
